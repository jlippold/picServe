...
- (void)createTable:(NSArray*)arguments withDict:(NSDictionary*)options
{
    ...
    if ( [[options objectForKey:@"showRightButton"] boolValue] == true) {
        ...
        UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(onRightButtonPress:)];
    ...
    if ( [[options objectForKey:@"showLeftButton"] boolValue] == true) {
        NSString *LeftButtonTitle = [options objectForKey:@"LeftButtonText"];
        
        UIBarButtonItem *leftButton = [[UIBarButtonItem alloc] initWithTitle:LeftButtonTitle
                                                                        style:UIBarButtonItemStyleDone
                                                                       target:self
                                                                       action:@selector(onLeftButtonPress:) ];
